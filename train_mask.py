...
def train(data_dir, model_dir, args):
    ...
    model_mask = model_module_mask(
        num_classes=args.num_classes_mask,
    ...
    with open(Path(save_dir) / 'mask' / 'config.json', 'w', encoding='utf-8') as f:
        ...
        with torch.no_grad():
            ...
            for val_batch in val_loader:
                ...
                if figure is None:
                    ...
                    figure = grid_image(inputs_np, labels_mask, preds_mask, args.dataset != "MaskSplitByProfileDataset")
                    plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_classes_mask', type=int, default=3, help='model_mask output classes (default: 3)')
