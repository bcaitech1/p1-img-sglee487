...
def train(data_dir, model_dir, args):
    ...
    wandb.init(project="trainm_01", config=vars(args))
    ...
    criterion_gender = create_criterion(args.criterion) # default: cross_entropy
    ...
    for epoch in range(args.epochs):
        ...
        for idx, train_batch in enumerate(train_loader):
            ...
            loss_value += loss_gender.item()
            loss_value += loss_age.item()
        ...
        with torch.no_grad():
            ...
            for val_batch in val_loader:
                ...
                val_loss_items.append(loss_item_mask)
                val_loss_items.append(loss_item_gender)
                val_loss_items.append(loss_item_age)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_ratio', type=float, default=0.1, help='ratio for validation (default: 0.2)')
